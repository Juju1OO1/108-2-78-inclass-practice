...
```{r ans1}
factor1 <-  factor(receipts300[1:30])
factor2 <- as.integer(factor1)
sum300 <- sum(factor2)
print(sum300)
...
poem_songOrder1 <- as.numeric(poem_songOrder)
poemsong1 <- as.vector(poem_song)
poem_song <- c(poem_songOrder1)
print(poem_song)
...
gender1=post[["comments"]][["gender"]]
post[["comments"]][["gender"]] <- as.factor(gender1)

heart1=post[["comments"]][["hearts"]]
post[["comments"]][["hearts"]] <- as.numeric(heart1)
str(post)
...
Date2 <- list(c(ymd_hms("2020-04-20 14:50:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 14:51:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 14:50:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 14:51:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 15:14:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 16:26:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 16:36:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 16:58:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 17:18:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 17:29:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 17:40:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 22:58:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 23:19:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 23:22:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 23:24:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 23:36:00",tz="Asia/Taipei"),ymd_hms("2020-04-20 23:55:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 00:02:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 00:40:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 00:51:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 00:56:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 00:59:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 01:00:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 07:23:00",tz="Asia/Taipei"),ymd_hms("2020-04-21 09:12:00",tz="Asia/Taipei")))
post[["comments"]][["DateTime"]] <- Date2
str(post)
...
```{r ans34}
post[["comments"]][["DateTime"]][[26]] <- ymd_hms("2020-04-25 03:50:00",tz="Europe/Warsaw")
...
```{r ans35}
category1 <- post[["category_dateTime"]][["category"]]
#dateTime1 <- post[["category_dateTime"]][["dateTime"]]
post
```
